...
<html lang="en">
  ...
  <body>
    <div class="main-box">
      ...
      <div
        class="right-box text-center d-md-flex align-items-center justify-content-center"
      >
        <div class="content">
          <div class="heading">
            <h5 class="text-uppercase primary-color">
              Our Reqruitement Process
            </h5>
          </div>
          <div class="icons d-md-flex align-items-center icons-row-one">
          ...
          <div
            class="icons d-md-flex align-items-center justify-content-center icons-row-two my-2"
          >
            <div class="icon-circle">
          ...
          <div class="apply-now-section p-2">
            <h4 class="primary-color text-uppercase">Apply Now</h4>
            <h4>
              <a
                class="text-dark text-decoration-none"
                href="careers.ideas.com.pk"
                >careers.ideas.com.pk</a
              >
            </h4>
          </div>
          ...
          <div class="linkedin-img my-3 gap-2 d-flex align-items-center justify-content-center">
<img width="30" src="{{asset('images/linkedin-icon.png')}}">
<small>LinkedIn/<br/>Ideas HR</small>
          </div>
        </div>
      </div>
      <div
        class="left-box text-center d-md-flex align-items-center justify-content-center"
      >
        <div class="content">
          <div class="heading">
          ...
          <div class="highlighted-text primary-bg text-white">
            <h6 class="text-uppercase">A great career in fashion retail</h6>
          </div>
          <div class="website">
            <h4>
              <a class="text-dark text-decoration-none" href="ideas.com.pk">
                ideas.com.pk</a
              >
            </h4>
          </div>
